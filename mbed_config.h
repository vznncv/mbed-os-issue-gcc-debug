...
#define CLOCK_SOURCE                                                          USE_PLL_HSE_EXTC|USE_PLL_HSI                                                                     // set by target:BLACKPILL_F401CC
...
#define MBED_CONF_TARGET_DEFAULT_ADC_VREF                                     3.3f                                                                                             // set by target:BLACKPILL_F401CC
